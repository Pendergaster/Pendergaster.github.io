...
This is implementation of NES emulator. The goal of the project was to visualize how the NES platform works.This also includes 6502-assembly code debugger for NES cartridges.
...
This projects goal was to implement HTTPS webserver in C, which can respond to queries and serve webpages. We used HTTP 1.1 protocol. Server was able to compile, run and output C-code given by the browser. Served webpage had WebGL background compiled by Emscripten. This was obviously just a fun project for learning!

- [x11 Snipping tool utility](https://github.com/Pendergaster/snippy)

This tool can capture part of your screen for user to paste it to applications. This is utility for my personal needs and currently **work in progress**. Althought this works but has problems with how some applications handle x11 clipboard.

Bright part of the image is selected region for capturing
...
This engine's goal was to simulate 3D Bullet physics in multiplayer environment. Raknet was used for network and OpenGL for rendering. Done as part of a school project.
...
This project was part of my grapchis programming studies. Provides basic Vulkan render foundation for other projects. This was great project to learn from! This project followed fairly closely [online tutorials](https://vulkan-tutorial.com/)

- [Oculus VR engine with OpenGL rendering](https://github.com/Pendergaster/VRstuff)

Project's goal was to implement VR rendering from the scrach. I decided to use Ovr library by Oculus. Project integrated 3D Bullet physics and animation pipeline.
